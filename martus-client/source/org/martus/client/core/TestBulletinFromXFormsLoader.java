...
public class TestBulletinFromXFormsLoader extends TestCaseEnhanced
{
	...
	{
		MockMartusSecuritySha2 secureAppAccount = MockMartusSecuritySha2.createOtherClient();
		MockMartusSecuritySha2 martusDesktopAccount = MockMartusSecuritySha2.createHQ();
...
"</h:html>";
	...
	private MockMartusSecuritySha2 security;

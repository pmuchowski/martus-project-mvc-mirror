...
abstract public class AbstractBulletinXmlExporter
{
	public AbstractBulletinXmlExporter(MartusApp appToUse, MiniLocalization localizationToUse, ProgressMeterInterface progressMeterToUse)
	{
		app = appToUse;
	...
	private void writeBulletinHistory(Writer dest, BulletinHistory history) throws IOException
	{
		if(history.size() > 0)
		{
	...
	private void writeAttachments(Writer dest, File attachmentsDirectory, AttachmentProxy[] attachments, String attachmentSectionTag) throws IOException
	{
	...
	private void writeFields(Writer dest, Bulletin b, FieldSpec[] specs) throws IOException
	{
	...
	abstract public boolean shouldGroupAttachments();

	protected MiniLocalization localization;
	protected MartusApp app;
	protected int bulletinsExported;
	protected int failingAttachments;
	protected ProgressMeterInterface progressMeter;

...
//					new String[] {"OK"});
	...
	private void startAccountSetupWizard()
	{
		try
		{
		    ...
		    if (UiSession.isLegacySetupWizard)		    	
		    	showWelcomeAndStartSignupProcess();
		    else
		    	showAndStartSignupProcess();
		} 
		catch (Exception e)
		{
			MartusLogger.logException(e);
	...
	private void showWelcomeAndStartSignupProcess() throws Exception
	{
		...
		createAndShowLegacySetupWizard();
	}
	
	private void showAndStartSignupProcess() throws Exception
	{
	...
	abstract public void createAndShowLegacySetupWizard() throws Exception;

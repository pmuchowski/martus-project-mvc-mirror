...
{
	public UiReportFieldSelectorPanel(UiMainWindow mainWindowToUse, FieldSpec[] rawFieldSpecs)
	{
	...
	{
		model = new SpecTableModel(rawFieldSpecs, getMainWindow().getLocalization());

...
"wintitle:notifyRetrieveServerTurnedOff=Retrieve Records",
...
"wintitle:notifyImportServerResponseFileJsonError=Json load error",
...
"wintitle:FileDialogImportBulletin=Import",
"wintitle:ImportServerResponseFile=Import Server Response File",
"wintitle:notifyImportServerResponseFile=Import Server Response File",
"wintitle:FileDialogImportServerResponseFile=Import Server Response File",
"field:notifyImportServerResponseFilecause=",
...
"tooltip:Help=Help",
"tooltip:ReadonlyDesktopFlavorSave=Save the record as a local draft",
"tooltip:Save=Save Record",
"tooltip:ReadonlyDesktopFlavorShare=Send record to contact and remove locally",
"tooltip:Share=Share Record",
"tooltip:ImportServerResponseFile=Import server response file from uploader.",
...
"button:RecoverAccountTab=Restore my account",
"button:SignInTab=Martus Sign In",
...
"field:ZipFileFilter=Zip Files (*.zip)",
"field:ServerResponseFileFilter=Uploader Response File (.txt)",
...
"field:DefaultPrintToDiskFileName=records",
...
"button:ZipRadioButton=Uploadable Zip",
...
"button:ExportAsCsv=Export as CSV",
...
"field:ExportZippedBulletins=Exporting uploadable zip",
...
"field:notifyRetrieveServerTurnedOffcause=The server connection is turned off, please connect to the server and try again.",
"field:notifyContactsNoServercause=The current server is not responding or may need to be configured from the server menu.",
"field:notifypasswordsdontmatchcause=Warning: You must enter the same password you entered above.",
"field:notifyusernamessdontmatchcause=Warning: You must enter the same username you entered above.",
...
"field:notifyErrorBackingupKeyPaircause=Unable to verify the backup. Please try again, possibly to a different destination.",
...
"field:notifyImportServerResponseFileJsonErrorcause=Json error while trying to load response file",
...
"field:ServerNameEntryInformation=Server's IP address",
"field:ServerPublicCodeEntry=Server Public Code ",
"field:ServerPublicCodeEntryInformation=Server's public code",
"field:PublicCode=Public Code ",
"field:ServerMagicWordEntry=Magic Word ",
"field:ServerMagicWordEntryInformation=Server's magic word",
...
"field:ChooseReportFields=Move the desired fields to the right column. Use Ctrl + Click or Shift-Click for multiple selection",
"field:SelectReportTemplate=Select a form template or choose \"All known fields\"",
"field:ReportStep1=Step 1: ",
"field:ReportStep2=Step 2: ",
"field:SelectedFields=Selected Fields",
"field:SelectFields=Select Fields",
...
"tooltip:ManageContacts=Manage Contacts",
...
"field:AddContactStep1AccessToken=1. Ask your contacts for their \"Access Token\"",
"field:AddContactStep1PublicKey=1. Ask your contacts for their \"Public Key\"",
...
"field:ContactAccessToken=Contact's Access Token",
"button:AddContact=Add Contact",
"button:ImportContactFromFile=Choose File",
...
"field:AccountUserNameInstructions=Username*",
"field:Password=Password ",
"field:PasswordInstructions=Password*",
"field:PasswordConfirmInstructions=Confirm Password*",
"field:UserWarning=You may lose your data if you forget this*",
"field:UsernameIsCaseSensitiveHint=Username is case sensitive",
...
"field:UsePrivateServer=Use Private Server",
...
"field:ImportingRecords=Importing files",
...
"field:UserDefaultServerOrYOurOwnTip=Use default server or setup your own",
"field:ServerSetupBorderTitle=Server Settings",
...
"field:FolderNameCases=Folder",
"field:FolderNameIncidents=Folder",
"field:FolderNameProjects=Folder",
"field:FolerNameUserDefined=Folder",

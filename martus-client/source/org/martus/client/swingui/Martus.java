...
public class Martus
{
    public static void main (String args[])
	{
		...
		int legacySignupWizardIndex = options.indexOf("--legacyJavaFxSignupWizard");
		if (legacySignupWizardIndex >= 0)
		{
			System.out.println("Starting martus legacy JavaFx signup process");
			UiSession.isLegacySetupWizard = true;
			options.remove(legacySignupWizardIndex);
		}

...
public class FxInSwingCreateNewAccountWizardStage extends FxInSwingWizardStage
{
	public FxInSwingCreateNewAccountWizardStage(UiMainWindow mainWindow) throws Exception
	{
		super(mainWindow, "SetupNewAccountWizard.css");
	}
	
	@Override
	protected FxWizardShellController createWizardShellController()
	{
		return new FxSetupNewAccountWizardShellController(getMainWindow());
	}

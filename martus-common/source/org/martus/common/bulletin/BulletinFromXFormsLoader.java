...
public class BulletinFromXFormsLoader extends AbtractXFormsLoader
{
	...
	private Bulletin createNewBulletinFromXFormsBulletin() throws Exception
	{
		...
		System.out.println("------------------------------------------------------------------XFORMS INSTANCE withOutRootElement start");
		System.out.println(xFormsInstanceXmlAsString);
		System.out.println("------------------------------------------------------------------XFORMS INSTANCE end");

		System.out.println("------------------------------------------------------------------XFORMS MODEL withOutRootElement start");
		System.out.println(xFormsModelXmlAsString);
		System.out.println("------------------------------------------------------------------XFORMS MODEL end");
	...
	private String getXFormsInstanceWithoutRootElement()
	{
		...
		System.out.println("------------------------------------------------------------------XFORMS INSTANCE withRootElement start");
		System.out.println(xFormsInstanceXmlAsString);
		System.out.println("------------------------------------------------------------------XFORMS INSTANCE end");
	...
	private String getXformsModelWithoutRootElement()
	{
		...
		System.out.println("------------------------------------------------------------------XFORMS MODEL withRootElement start");
		System.out.println(xFormsModelXmlAsString);
		System.out.println("------------------------------------------------------------------XFORMS MODEL end");

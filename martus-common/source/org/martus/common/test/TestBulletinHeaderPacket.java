...
public class TestBulletinHeaderPacket extends TestCaseEnhanced
{
	...
	public void testWriteXml() throws Exception
	{
		...
		assertContains(MartusXml.getTagStart(MartusXml.AllowNonAuthorUpload), result);
		assertContains(MartusXml.getTagEnd(MartusXml.AllowNonAuthorUpload), result);
	...
	{
		BulletinHeaderPacket bhpToTest = createSampleBulletinHeaderPacket();
	...
	private BulletinHeaderPacket createSampleBulletinHeaderPacket() throws Exception
	{
	...
	public void testEnableNonAuthorUpload() throws Exception
	{
		BulletinHeaderPacket bulletinHeaderPacket = createSampleBulletinHeaderPacket();
		assertFalse("Bulletin should not be allowed to be uploade by a non author", bulletinHeaderPacket.allowNonAuthorUpload());
		
		bulletinHeaderPacket.enableNonAuthorUpload();
		assertTrue("Bulletin should be allowed to be uploaded by a non author?", bulletinHeaderPacket.allowNonAuthorUpload());
	}
	
	private static final String hqAccountId = "";

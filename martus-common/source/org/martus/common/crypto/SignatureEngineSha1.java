...
public class SignatureEngineSha1 implements SignatureEngine
{
	public static SignatureEngine createSigner(MartusKeyPair keyPair) throws Exception
	{
		SignatureEngineSha1 engine = new SignatureEngineSha1();
	...
	private SignatureEngineSha1() throws Exception
	{
